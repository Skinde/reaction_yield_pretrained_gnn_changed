...
#Standard loss formula added by Lama due to tsne having no eigenvalues
...
def pretrain_moldescpred(
    ...
    pretrained_model_path = "./model/pretrained/" + "%d_pretrained_gnn_tsne.pt" % (seed)
...
class Pretraining_Dataset:
    ...
    def load(self, mode):
        ...
        # Applying TSNE to reduce the dimensionality of descriptors
